...
const EditOperatorProduksi = () => {
  ...
  const addData = async (data) => {
    try {
      ...
      if (res.status === 200) {
        toast.success("Operator Produksi berhasil diedit", {
          position: "top-right",
      ...
      if (res.status === 400) {
        toast.error("Gagal edit Operator Produksi", {
          position: "top-right",
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Form edit user dengan role operator produksi
                </p>
              </div>
...
export default EditOperatorProduksi;
