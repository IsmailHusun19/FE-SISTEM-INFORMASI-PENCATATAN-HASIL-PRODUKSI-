...
const KetuaRegu = () => {
  ...
  const handleAdd = () => {
    navigate("/pengguna/tambah/ketua regu");
  };
  const handleEdit = (id) => {
    navigate(`/pengguna/edit/ketua regu/${id}`);
  };
                ...
                <div className="w-full max-w-sm min-w-[300px] relative">
                  <div className="relative">
                    <input
                      ...
                      placeholder="Search for ketua regu..."
                    />
                    ...
                    <tr>
                      <td colSpan={5} className="p-4 text-center text-grey-400">
                        {search
                          ...
                          : "Data Ketua Regu belum tersedia"}
                      </td>
                    </tr>
                  )}
                </tbody>
