...
const OperatorProduksi = () => {
  ...
  const getData = async () => {
    try {
      ...
      const ketugaReguUsers = users.data.filter(
        (user) => user.role === "OPERATOR_PRODUKSI"
      );
      setUsers(ketugaReguUsers);
    } catch (error) {
  ...
  const handleAdd = () => {
    navigate("/pengguna/tambah/operator produksi");
  };
  const handleEdit = (id) => {
    navigate(`/pengguna/edit/operator produksi/${id}`);
  };
                ...
                <div className="w-full max-w-sm min-w-[300px] relative">
                  <div className="relative">
                    <input
                      ...
                      placeholder="Search for oprator produksi..."
                    />
                    ...
                    <tr>
                      <td colSpan={5} className="p-4 text-center text-grey-400">
                        {search
                          ...
                          : "Data Oprator Produksi belum tersedia"}
                      </td>
                    </tr>
                  )}
                </tbody>
...
export default OperatorProduksi;
