...
import { AddDataLine } from "../service/Api";
...
const AddLine = () => {
  ...
  const addData = async (data) => {
    try {
      const res = await AddDataLine(data);
      console.log(res);
      ...
      if (res.status === 400) {
        toast.error("Gagal menambahkan line", {
          position: "top-right",
        ...
        >
          <div className="w-full text-gray-200 p-6">
            ...
            <form onSubmit={handleSubmit} className="rounded-lg">
              ...
              placeholder="Example: Line Produksi 1"
                />
              </div>
