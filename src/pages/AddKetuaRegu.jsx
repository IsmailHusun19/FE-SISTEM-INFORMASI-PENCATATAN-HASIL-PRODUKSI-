...
const AddKetuaRegu = () => {
  ...
  const addData = async (data) => {
    try {
      ...
      if (res.status === 201) {
        toast.success("Ketua Regu berhasil ditambahkan", {
          position: "top-right",
      ...
      if (res.status === 400) {
        toast.error("Gagal menambahkan Ketua Regu", {
          position: "top-right",
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Form pendaftaran user dengan role ketua regu
                </p>
              </div>
