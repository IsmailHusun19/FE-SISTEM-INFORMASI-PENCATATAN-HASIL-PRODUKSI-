...
import { GetAllLine, DeleteLine } from "../service/Api";
...
const Line = () => {
  ...
  const totalItems = filteredLine.length;
  const totalPages = Math.ceil(totalItems / ITEMS_PER_PAGE);
  const startIndex = (currentPage - 1) * ITEMS_PER_PAGE;
  const endIndex = startIndex + ITEMS_PER_PAGE;
  const currentline = filteredLine.slice(startIndex, endIndex);
  useEffect(() => {
    setCurrentPage(1);
  }, [search]);
                ...
                <thead>
                  <tr>
                    ...
                    <th className="p-4 border-b border-slate-500 bg-gray-900">
                      <p className="text-sm font-bold text-grey-200">Nama Line</p>
                    </th>
                    <th className="p-4 border-b border-slate-500 bg-gray-900">
