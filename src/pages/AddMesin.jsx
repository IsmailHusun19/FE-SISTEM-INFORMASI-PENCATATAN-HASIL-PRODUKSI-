...
import { AddDataMesin } from "../service/Api";
...
const AddMesin = () => {
  ...
  const addData = async (data) => {
    try {
      const res = await AddDataMesin(data);
      console.log(res);
      ...
      if (res.status === 400) {
        toast.error("Gagal menambahkan Mesin", {
          position: "top-right",
          description: "Nama atau nomor mesin sudah digunakan mesin lain",
        });
        return null;
      }
    } catch (error) {
