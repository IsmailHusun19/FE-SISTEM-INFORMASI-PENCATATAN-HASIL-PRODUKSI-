...
import { GetAllProduct, DeleteProduct } from "../service/Api";
                ...
                <thead>
                  <tr>
                    ...
                    <th className="p-4 border-b border-slate-500 bg-gray-900">
                      <p className="text-sm font-bold text-grey-200">Nama Product</p>
                    </th>
                    <th className="p-4 border-b border-slate-500 bg-gray-900">
                      <p className="text-sm font-bold text-grey-200">Deskrpsi</p>
                    </th>
                    <th className="p-4 border-b border-slate-500 bg-gray-900">
                    ...
                    currentProduct.map((user, index) => (
                      ...
                      >
                        ...
                        <td className="p-4 py-5 max-w-[350px]">
                          <p className="text-sm text-grey-200">{user.deskripsi}</p>
                        </td>
