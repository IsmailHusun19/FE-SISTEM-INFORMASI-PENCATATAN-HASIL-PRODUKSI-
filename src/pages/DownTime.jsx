...
import { GetProduksiDownTime } from "../service/Api";
...
const DownTime = () => {
  ...
  const getData = async () => {
    try {
      const produksi = await GetProduksiDownTime();
              ...
              <table className="w-full text-left table-auto min-w-max">
                <thead>
                  <tr>
                    ...
                    <th className="p-4 border-b border-slate-500 bg-gray-900">
                      <p className="text-sm font-bold text-grey-200">Total Down Time</p>
                    </th>
                    <th className="p-4 border-b border-slate-500 bg-gray-900">
                  ...
                  {currentproduksi.length > 0 ? (
                    currentproduksi.map((user, index) => (
                      ...
                      >
                        ...
                        <td className="p-4 py-5">
  <p className="text-sm text-grey-200">
    {(user.monitoring_mesin || []).reduce(
      (sum, mesin) => sum + (mesin.downtime || 0),
      0
    )} menit
  </p>
</td>
